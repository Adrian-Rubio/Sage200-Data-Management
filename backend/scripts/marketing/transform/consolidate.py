...
def consolidate_data():
    ...
    mailchimp_path = os.path.join("data", "marketing", "mailchimp_data.json")
    prestashop_path = os.path.join("data", "marketing", "prestashop_data.json")
    ...
    with open(os.path.join("data", "marketing", "unified_data.json"), "w", encoding="utf-8") as f:
