            ...
            <form onSubmit={(e) => { e.preventDefault(); loadData(); }} className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 mb-6 font-sans">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-4 items-end">
                    <div>
                        ...
                        <input name="exercise" type="number" value={filters.exercise || ''} onChange={handleFilterChange} placeholder="2026" className="w-full rounded-lg border-slate-200 shadow-sm focus:border-indigo-500 focus:ring-0 text-xs p-2.5 font-bold text-slate-700 bg-slate-50" />
                    </div>
                    <div>
                        ...
                        <select
                            ...
                            className="w-full rounded-lg border-slate-200 shadow-sm focus:border-indigo-500 focus:ring-0 text-xs p-2.5 font-bold text-slate-700 bg-slate-50"
                        >
                    ...
                    <div>
                        ...
                        <input name="series" type="text" value={filters.series || ''} onChange={handleFilterChange} placeholder="Ej: CP" className="w-full rounded-lg border-slate-200 shadow-sm focus:border-indigo-500 focus:ring-0 text-xs p-2.5 font-bold text-slate-700 bg-slate-50" />
                    </div>

                    <div>
                        <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Nº Pedido</label>
                        <input name="order_num" type="number" value={filters.order_num || ''} onChange={handleFilterChange} placeholder="Pedido" className="w-full rounded-lg border-slate-200 shadow-sm focus:border-indigo-500 focus:ring-0 text-xs p-2.5 font-bold text-slate-700 bg-slate-50" />
                    </div>

                    <div>
                        <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Proveedor</label>
                        <input name="provider" type="text" value={filters.provider || ''} onChange={handleFilterChange} placeholder="Nombre prov..." className="w-full rounded-lg border-slate-200 shadow-sm focus:border-indigo-500 focus:ring-0 text-xs p-2.5 font-bold text-slate-700 bg-slate-50" />
                    </div>

                    <div>
                        <button type="submit" className="w-full bg-indigo-600 text-white px-4 py-2.5 rounded-lg hover:bg-slate-900 transition font-bold text-xs h-[38px] flex items-center justify-center gap-2 shadow-sm">
                            🔍 Aplicar Filtros
                        </button>
                    </div>
                </div>
