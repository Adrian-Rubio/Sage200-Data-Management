...
import { 
  LayoutDashboard, TrendingUp, Clock, Receipt, Users, DollarSign, ArrowUpRight, ArrowDownRight, Menu, X, ChevronRight, Gift, Calendar, Search, FileText, ArrowRight, ArrowLeft, ArrowRightLeft, ArrowUpDown, ArrowUp, ArrowDown
} from 'lucide-react';
      ...
      <div className="bg-[#172035]/80 backdrop-blur-md rounded-2xl border border-white/10 shadow-xl p-6 h-full flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="overflow-x-auto flex-1">
          <table className="w-full text-left border-separate border-spacing-y-2">
            <thead>
              <tr className="text-slate-400 text-xs font-black uppercase tracking-wider">
                <th className="pb-4 pl-4 cursor-pointer hover:text-white transition-colors" onClick={() => handleCashflowSort('local')}>
                  <div className="flex items-center gap-2">
                    Local <SortIcon field="local" />
                  </div>
                </th>
                <th className="pb-4 cursor-pointer hover:text-white transition-colors" onClick={() => handleCashflowSort('date')}>
                  <div className="flex items-center gap-2">
                ...
                <th className="pb-4">Responsable</th>
                <th className="pb-4 text-right pr-6 cursor-pointer hover:text-white transition-colors" onClick={() => handleCashflowSort('amount')}>
