    ...
    return (
        <div className="relative w-full h-full group">
            ...
            <div className="absolute top-2 left-4 z-10">
                <h3 className="text-xs font-black text-slate-700 dark:text-slate-300 uppercase tracking-tighter flex items-center gap-2">
            ...
            <button
                onClick={prevSlide}
                className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 p-2 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-all text-slate-600 dark:text-slate-300 z-20"
            >
            ...
            <button
                onClick={nextSlide}
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 p-2 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-all text-slate-600 dark:text-slate-300 z-20"
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5">
