...
export function TopSubfamiliesChart({ data, isEmbed = false }) {
        ...
        <div className={`w-full ${isEmbed ? 'h-full' : 'h-[350px] bg-white p-6 rounded-2xl shadow-sm border border-slate-100'}`}>
            ...
            <div className={isEmbed ? "h-full" : "h-[300px]"}>
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data || []} layout="vertical" margin={{ left: 120, right: 80, top: 20, bottom: 20 }}>
                        ...
                        <Bar dataKey="value" radius={[0, 4, 4, 0]} barSize={24} label={{ position: 'right', fill: '#ef4444', fontSize: 10, fontWeight: 'bold', formatter: (val) => formatCurrency(val) }}>
